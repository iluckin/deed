                                        ...
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="active nav-link">
                                                    <span class="text-dark">车位产权信息 [{{ optional($item->community)->name ?? '--' }}]</span>
                                                </a>
                                            </li>
                                        </ul>
                                        <div class="tab-content pt-3">
                                            <div class="tab-pane active text-dark">
                                                <form class="form" action="{{ route('car.update', $item->id) }}" novalidate="" name="create-category" enctype="multipart/form-data" method="post">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="row">
                                                        ...
                                                        <div class="col text-dark">
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        <div class="form-group">
                                                                            <label>车位 <small class="text-danger">* 必填</small></label>
