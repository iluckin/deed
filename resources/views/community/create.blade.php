...
{{--                                        </div>--}}
                                        ...
                                        <div class="tab-content pt-3">
                                            <div class="tab-pane active text-dark">
                                                <form class="form" action="{{ route('community.store') }}" novalidate="" name="create-category" enctype="multipart/form-data" method="post">
                                                    @csrf
                                                    <div class="row">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="city_id" class="select2 form-control select2-selection">
                                                                            @foreach(['1' => '新人', '0' => '普通'] as $id => $name)
                                                                                <option @if($id == old('city_id')) selected @endif value="{{ $id }}">{{ $name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="town_id" class="select2 form-control select2-selection">
                                                                            @foreach(['1' => '新人', '0' => '普通'] as $id => $name)
                                                                                <option @if($id == old('town_id')) selected @endif value="{{ $id }}">{{ $name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control" type="text" name="name" placeholder="小区名称" value="{{ old('name') }}" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control" type="text" name="contact_name" placeholder="联系人" value="{{ old('contact_name') }}" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control" type="text" name="contact_phone" placeholder="联系人电话" value="{{ old('contact_phone') }}" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
