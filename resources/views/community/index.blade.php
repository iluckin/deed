                    ...
                    <div class="row">
                        <div class="col">
                            <p class="font-weight-bold text-primary">
                                <i class="fa fa-list-ul"></i> 小区列表 ({{ $items->count() }})
                            </p>
                        </div>
                    </div>
                        ...
                        @forelse($items ?? [] as $item)
                            <div class="col-sm-6 col-md-6 col-lg-3">
                                <div class="e-panel card mb-3 bordered-hover card-list-item">
                                    @if($item->deleted_at)
                                        <div class="status bg-dark text-white small pt-3">
                                            <small>已删</small>
                                        </div>
                                    @endif
                                                ...
                                                <div class="card-title">
                                                    <h6 class="mr-2">
                                                        <span class="text-dark">
                                                            <a href="{{ route('community.edit', $item->id) }}" class="text-dark font-weight-bold">
                                                                {{ $item->name }}
                                                            </a>
                                                        </span>
                                                        <br>
