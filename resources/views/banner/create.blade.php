                    ...
                    <div class="row">
                        <div class="col">
                            <p class="font-weight-bold text-primary">
                                <i class="fa fa-bookmark"></i> 新增轮播图
                            </p>
                        </div>
                    </div>
                                    ...
                                    <div class="e-profile">
                                        ...
                                        <div class="tab-content pt-3">
                                            <div class="tab-pane active text-dark">
                                                <form class="form" action="{{ route('banner.store') }}" novalidate="" name="create-category" enctype="multipart/form-data" method="post">
                                                    @csrf
                                                    <div class="row">
                                                              ...
                                                              <div class="col">
                                                                <div class="form-group">
                                                                  <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="title" placeholder="标题" value="{{ old('title') }}" required>
                                                                  </div>
                                                                </div>
                                                              </div>
                                                            </div>
                                                                ...
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control" type="number" name="top" placeholder="排序" value="{{ old('top', 0) }}" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                ...
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input class="form-control" type="text" name="link" placeholder="http(s)://" value="{{ old('link') }}" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
